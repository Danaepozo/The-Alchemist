...
export const metadata: Metadata = {
  ...
  description: 'Longevity, biohacking and regenerative medicine in Miami (Coral Gables) where vanguard science meets the soul. Functional medicine, hormone optimization, peptide therapy, IV therapy, NAD+, nervous-system regulation and spiritual healing — integral healing of body & soul. By Holistic Bella Vargas & Dr. Michael J. Meighen, MD.',
              ...
              '@graph': [
                {
                  ...
                  alternateName: ['Alchemized BioHealing', 'Holistic Bella & Dr. Michael J. Meighen, MD'],
